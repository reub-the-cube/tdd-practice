...
{
    public class NumberOfNiceStringsForPartOne
    {
        [Fact]
        ...
        [Fact]
        public void InputListForPartOneHasXNiceStrings()
        {
            List<string> list = [
                "uxcplgxnkwbdwhrp",
"suerykeptdsutidb",
...
"wtebigbaythklkbd"
    ...
    public class NumberOfNiceStringsForPartTwo
    {
        [Fact]
        public void EmptyListHasNoNiceStrings()
        {
        ...
        [Fact]
        public void ExampleListForPartTwoHasTwoNiceStrings()
        {
            List<string> list = [
                "qjhvhtzxzqqjkmpb",
                "xxyxx",
